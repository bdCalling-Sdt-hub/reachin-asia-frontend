...
const CompanyBusinessCard = ({ id }: { id: string }) => {
      ...
      const socialMediaData = [
            { name: 'Instagram', icon: Instagram, url: company?.instagram || 'https://instagram.com' },
            { name: 'Facebook', icon: Fb, url: company?.facebook || 'https://facebook.com' },
            { name: 'YouTube', icon: YT, url: company?.youtube || 'https://youtube.com' },
            { name: 'LinkedIn', icon: Linkedin, url: company?.linkedin || 'https://linkedin.com' },
            { name: 'X', icon: X, url: company?.twitter || 'https://x.com' },
      ];
      return (
                        ...
                        <div className="col-span-12 md:col-span-4 ">
                              ...
                              <div className="flex flex-col md:flex-row items-center gap-4 text-subtitle h-full">
                                    ...
                                    <div className="text-start md:text-center">
                                          <h2 className="text-xl font-semibold text-title ">Jack Smith</h2>
                        ...
                        <div className="col-span-12 md:col-span-8 grid grid-cols-1 md:grid-cols-3 my-4 justify-center text-center md:text-start">
                              ...
                              <div className=" space-y-5">
                                    <div>
                                          ...
                                          <p className="font-semibold text-[#4E4E4E]">{company?.companyName}</p>
                                    </div>
                              ...
                              <div className=" space-y-5">
                                    <div>
                                          ...
                                          <p className="font-semibold text-[#4E4E4E]">{company?.website}</p>
                                    </div>
                                    {/* Social Media Icons */}
                              ...
                              <div className=" space-y-5">
                                    ...
                                    <div>
                                          ...
                                          <p className="font-semibold text-[#4E4E4E]">+{company?.employeeTotal}</p>
                                    </div>
                              </div>
                        </div>
                  </div>
